...
import { Dumbbell, Clock, Bike, Sparkles, Mountain, PersonStanding, ChevronDown } from 'lucide-react'
...
export function HistoryFeed({ todayLogs, totalActiveMinutes }) {
  ...
  return (
    <aside className="bg-white rounded-2xl shadow-card border border-slate-50 flex flex-col">
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        className="px-4 py-3.5 flex items-center justify-between shrink-0 w-full text-left"
      >
            ...
            {empty ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-xs text-slate-300 mt-1 leading-relaxed">
                  Complete a set to<br />begin tracking
                </p>
              </div>
            ) : (
