...
export const INITIAL_EXERCISES = [
  ...
  },
  {
    ...
    totalSets: 3,
    muscles: ['Lats', 'Rhomboids', 'Rear Delts'],
    gifUrl: `${GIF_BASE}/upper-back/dumbbell-incline-row.gif`,
    formTip:
      'Lie face down on an incline surface (chair back, bench, or ottoman), or brace your non-working hand on a chair seat. Let dumbbells hang, arms straight. Row to your hips, leading with the elbow — squeeze the shoulder blade hard at the top. Let arms hang fully on the way down for a complete lat stretch.',
  },
  {
    id: 'bicep-curl',
    name: 'Bicep Curl',
  ...
  },
  {
    ...
    targetReps: 10,
    totalSets: 3,
    muscles: ['Abs', 'Hip Flexors', 'Core Stabilizers'],
    gifUrl: `${GIF_BASE}/abs/dead-bug.gif`,
    formTip:
      'Lie on your back, arms pointing straight up, knees bent 90°, shins parallel to floor. Press your lower back firmly into the floor — maintain this throughout. Slowly lower opposite arm and leg toward the floor without letting your lower back rise. Stop just before contact, return to start. Move deliberately; speed is the enemy here.',
  },
  {
    id: 'side-bend',
    name: 'Side Bend',
  ...
  },
  {
    ...
    gifUrl: null,
    formTip:
      'Start on hands and knees, wrists under shoulders, knees under hips. Brace your core — imagine balancing a cup of water on your lower back. Simultaneously extend your right arm forward and left leg back. Hold 2 seconds, return to start without letting the spine twist or the hip drop. Alternate sides. Move slowly; speed is the enemy here.',
  },
]
